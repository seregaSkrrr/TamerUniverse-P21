...
class Save : public ISave{
	void Uploadfile();			//функция будет запрашивать переменные соответствующие составу игры: корабли, планеты и т.д. Будет брать данные из текстового файла (приложенный в папке с этим проектом) и менять данные переданные
